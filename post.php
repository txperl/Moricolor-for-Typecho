        ...
        <article class="post" style="padding-top: 20px;">
            ...
            <div class="text-right">
                <?php if ($GLOBALS['style_TextBar'] == '1') : ?>
                    <?php while ($GLOBALS['beta_MoreFunctions'] == 'on') : ?>
                        <div class="text-bar">
                            ...
                            <a href="<?php $this->options->feedUrl(); ?>" rel="nofollow" data-placement="bottom" data-toggle="tooltip" title="文章 RSS" class="fui-post-rss"></a>
                            <a href="<?php $this->options->commentsFeedUrl(); ?>" rel="nofollow" data-placement="bottom" data-toggle="tooltip" title="评论 RSS" class="fui-comment-rss"></a>
                        </div>
                        <div class="post-info">
